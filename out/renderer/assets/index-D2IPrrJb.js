            ...
            if (null !== priorSelectionRange && hasSelectionCapabilities(priorFocusedElem)) {
              ...
              if ("selectionStart" in priorFocusedElem)
                ...
                if (win2.getSelection) {
                  var selection2 = win2.getSelection(), length = priorFocusedElem.textContent.length, start$jscomp$0 = Math.min(priorSelectionRange.start, length), end$jscomp$0 = void 0 === priorSelectionRange.end ? start$jscomp$0 : Math.min(priorSelectionRange.end, length);
...
function useStore$1(api, selector2 = identity$3) {
...
const createImpl = (createState) => {
  ...
  const useBoundStore = (selector2) => useStore$1(api, selector2);
...
const useBoardStore = create$1((set2, get2) => ({
  // 初期状態
  board: null,
  nodes: [],
  summaries: [],
  ...
  updateNode: (nodeId, updates) => {
    set2((state) => ({
      nodes: state.nodes.map(
        (n) => n.id === nodeId ? { ...n, ...updates, updatedAt: (/* @__PURE__ */ new Date()).toISOString() } : n
      ),
      isDirty: true
    }));
  },
  deleteNode: (nodeId) => {
    set2((state) => {
      ...
      const getDescendants = (id2) => {
        ...
        if (!node) return [];
        return [id2, ...node.childrenIds.flatMap(getDescendants)];
      };
      const nodesToDelete = new Set(getDescendants(nodeId));
      const updatedNodes = state.nodes.filter((n) => !nodesToDelete.has(n.id)).map((n) => ({
        ...n,
        childrenIds: n.childrenIds.filter((id2) => !nodesToDelete.has(id2)),
        parentIds: n.parentIds.filter((id2) => !nodesToDelete.has(id2))
      }));
      return {
        nodes: updatedNodes,
  ...
  selectNode: (nodeId) => {
    set2({ selectedNodeId: nodeId });
  },
  updateNodePosition: (nodeId, x, y) => {
    set2((state) => ({
      nodes: state.nodes.map(
        (n) => n.id === nodeId ? { ...n, position: { x, y }, updatedAt: (/* @__PURE__ */ new Date()).toISOString() } : n
      ),
      isDirty: true
    }));
  },
  ...
  getNodeById: (nodeId) => {
    return get2().nodes.find((n) => n.id === nodeId);
  },
...
const useSettingsStore = create$1((set2, get2) => ({
  settings: {
    theme: "system"
  },
  isLoaded: false,
...
const SettingsDialog = ({ isOpen, onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { margin: "0 0 20px 0", fontSize: "18px" }, children: "⚙️ 設定" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", marginBottom: "6px", fontSize: "14px" }, children: "OpenAI API Key" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "12px", color: "#64748b", marginTop: "6px" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            style: { color: "#6366f1" },
            children: "APIキーの取得はこちら"
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", marginBottom: "6px", fontSize: "14px" }, children: "ボード管理用の親フォルダ" }),
...
const BoardSelectorDialog = ({ isOpen, onClose }) => {
  const { setBoard, setFilePath, setLoading } = useBoardStore();
  const [boards, setBoards] = reactExports.useState([]);
  const [parentFolder, setParentFolder] = reactExports.useState(null);
  const [isLoadingList, setIsLoadingList] = reactExports.useState(false);
  reactExports.useEffect(() => {
    if (isOpen) {
      loadBoardList();
      loadParentFolder();
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { margin: 0, fontSize: "18px" }, children: "📂 ボードを開く" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: onClose,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "12px", color: "#94a3b8", marginBottom: "8px" }, children: "親フォルダ" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
              ...
              overflow: "auto",
              minHeight: "200px"
            }, children: isLoadingList ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", padding: "40px", color: "#64748b" }, children: "読み込み中..." }) : !parentFolder ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", padding: "40px", color: "#64748b" }, children: "親フォルダを選択してください" }) : boards.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", padding: "40px", color: "#64748b" }, children: "ボードが見つかりません" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: "8px" }, children: boards.map((board) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  board.description && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
                    fontSize: "12px",
                    color: "#94a3b8",
                    marginBottom: "6px",
                    overflow: "hidden",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "11px", color: "#64748b" }, children: [
                    "更新: ",
...
const Toolbar = () => {
  ...
  const handleSaveBoard = async () => {
    ...
    setLoading(true);
    try {
      const path = await window.electronAPI.saveBoard(data, useBoardStore.getState().filePath || void 0);
      if (path) {
        setFilePath(path);
        markClean();
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Mind Digger" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      board && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        fontSize: "14px",
        color: "#94a3b8",
        display: "flex",
        alignItems: "center",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "📋" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: board.title })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    showNewBoardDialog && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      position: "fixed",
      top: 0,
      left: 0,
      right: 0,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { margin: "0 0 16px 0", fontSize: "18px" }, children: "🆕 新規ボードを作成" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "16px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", marginBottom: "6px", fontSize: "14px" }, children: "タイトル *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "24px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", marginBottom: "6px", fontSize: "14px" }, children: "説明（テーマ・悩み）" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
...
const RootNode = reactExports.memo(({ data, selected: selected2 }) => {
  const nodeData = data;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `root-node ${selected2 ? "selected" : ""}`,
      style: {
        padding: "20px 30px",
        borderRadius: "16px",
        ...
        fontWeight: "bold",
        fontSize: "16px",
        boxShadow: selected2 ? "0 0 0 3px #c7d2fe, 0 4px 20px rgba(99, 102, 241, 0.4)" : "0 4px 20px rgba(99, 102, 241, 0.3)",
        minWidth: "150px",
        maxWidth: "300px",
        textAlign: "center",
        cursor: "pointer",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: "4px" }, children: "📌" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: nodeData.title || "テーマ" }),
        nodeData.content && nodeData.content !== nodeData.title && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          fontSize: "12px",
          opacity: 0.8,
          marginTop: "8px",
          fontWeight: "normal"
        }, children: nodeData.content.length > 100 ? nodeData.content.slice(0, 100) + "..." : nodeData.content }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Handle,
          {
            type: "source",
...
const MessageNode = reactExports.memo(({ data, selected: selected2 }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `message-node ${selected2 ? "selected" : ""}`,
      ...
      style: {
        padding: "12px 16px",
        borderRadius: "12px",
        background: isUser ? "linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%)" : "linear-gradient(135deg, #10b981 0%, #059669 100%)",
        color: "white",
        fontSize: "14px",
        boxShadow: selected2 ? `0 0 0 3px ${isUser ? "#bfdbfe" : "#a7f3d0"}, 0 4px 12px rgba(0, 0, 0, 0.15)` : "0 4px 12px rgba(0, 0, 0, 0.1)",
        minWidth: "120px",
        maxWidth: "280px",
        cursor: "pointer",
        transition: "box-shadow 0.2s ease"
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isUser ? "💬" : "🤖" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isUser ? "あなた" : "AI" }),
          nodeData.model && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
            fontSize: "10px",
        ...
        }, children: nodeData.content.length > 150 ? nodeData.content.slice(0, 150) + "..." : nodeData.content }),
        isHovered && !isUser && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          position: "absolute",
          bottom: "-32px",
          left: "50%",
...
const NoteNode = reactExports.memo(({ data, selected: selected2 }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `note-node ${selected2 ? "selected" : ""}`,
      onClick: handleNodeClick2,
      onMouseEnter: () => setIsHovered(true),
      onMouseLeave: () => setIsHovered(false),
      style: {
        padding: "12px 16px",
        borderRadius: "8px",
        background: isPinned ? "linear-gradient(135deg, #f59e0b 0%, #d97706 100%)" : "linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)",
        color: "#78350f",
        fontSize: "14px",
        boxShadow: selected2 ? "0 0 0 3px #fde68a, 0 4px 12px rgba(245, 158, 11, 0.3)" : "0 4px 12px rgba(245, 158, 11, 0.2)",
        minWidth: "100px",
        maxWidth: "250px",
        cursor: "pointer",
        transition: "box-shadow 0.2s ease",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          ...
          lineHeight: "1.4",
          wordBreak: "break-word"
        }, children: nodeData.content.length > 120 ? nodeData.content.slice(0, 120) + "..." : nodeData.content }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Handle,
          {
            type: "source",
...
const TopicNode = reactExports.memo(({ data, selected: selected2 }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `topic-node ${selected2 ? "selected" : ""}`,
      onClick: handleNodeClick2,
      onMouseEnter: () => setIsHovered(true),
      onMouseLeave: () => setIsHovered(false),
      style: {
      ...
      children: [
        ...
        nodeData.metadata?.tags && nodeData.metadata.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          ...
          gap: "4px",
          justifyContent: "center"
        }, children: nodeData.metadata.tags.slice(0, 3).map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            style: {
              fontSize: "10px",
        ...
        isHovered && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          position: "absolute",
          bottom: "-28px",
          left: "50%",
          transform: "translateX(-50%)",
...
function mindNodeToFlowNode(node) {
  return {
    id: node.id,
    type: node.type,
...
function createEdges(nodes) {
  const edges = [];
  nodes.forEach((node) => {
    node.parentIds.forEach((parentId, index2) => {
      edges.push({
        id: `${parentId}-${node.id}`,
        source: parentId,
        target: node.id,
        ...
        style: {
          strokeWidth: index2 === 0 ? 2 : 1,
          stroke: index2 === 0 ? "#555" : "#aaa"
        },
        animated: index2 !== 0
      });
    });
...
const MindMapCanvas = () => {
  ...
  const flowNodes = reactExports.useMemo(() => {
    return mindNodes.map((node) => ({
      ...mindNodeToFlowNode(node),
      selected: node.id === selectedNodeId
    }));
  }, [mindNodes, selectedNodeId]);
  const flowEdges = reactExports.useMemo(() => createEdges(mindNodes), [mindNodes]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: "100%", height: "100%", position: "relative" }, children: [
    isConnectingParent && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      position: "absolute",
      top: "20px",
      left: "50%",
      transform: "translateX(-50%)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      index,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Background, { variant: BackgroundVariant.Dots, gap: 20, size: 1 })
        ]
      }
    )
  ] });
...
const SidePanel = () => {
  ...
  const handleForkQuestion = reactExports.useCallback(() => {
    if (!selectedNode || !board) return;
  ...
  const handleDeleteNode = reactExports.useCallback(() => {
    if (!selectedNode) return;
    if (selectedNode.type === "root") {
      alert("ルートノードは削除できません");
      return;
    }
    const confirmed = window.confirm("このノードと配下を削除しますか？\n!注意!のノードに繋がる下のノードもすべて削除されます。");
    if (!confirmed) return;
  ...
  const handleStartConnectParent = reactExports.useCallback(() => {
    if (!selectedNode) return;
    startConnectingParent(selectedNode.id);
    alert("接続したい親ノードをキャンバス上でクリックしてください");
  }, [selectedNode, startConnectingParent]);
  const handleCancelConnectParent = reactExports.useCallback(() => {
    cancelConnectingParent();
  }, [cancelConnectingParent]);
  const handleToggleTimeline = reactExports.useCallback(() => {
    setShowTimeline(!showTimeline);
  }, [showTimeline]);
  const getTimelineNodes = reactExports.useCallback(() => {
    if (!selectedNode) return [];
    const timeline = [];
  ...
  if (!board) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: panelStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", color: "#64748b", padding: "40px 20px" }, children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: panelStyle, children: [
    ...
    selectedNode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "16px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { margin: 0, fontSize: "14px", color: "#94a3b8" }, children: "🕒 タイムライン" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: showTimeline ? "▼ 閉じる" : "▶ 表示"
          }
        )
      ] }),
      showTimeline && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
        maxHeight: "300px",
        overflow: "auto",
        background: "#1e293b",
        borderRadius: "8px",
        padding: "8px"
      }, children: getTimelineNodes().map((node, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
            marginBottom: "8px",
            ...
            borderRadius: "6px",
            borderLeft: index2 === 0 ? "none" : "2px solid #475569",
            marginLeft: index2 === 0 ? "0" : "12px"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
              fontSize: "11px",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: getNodeTypeLabel(node.type) }),
              node.role && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
                padding: "2px 6px",
            ...
            node.title && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
              fontSize: "13px",
              fontWeight: "bold",
              marginBottom: "4px",
              color: "#e2e8f0"
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
              ...
              maxHeight: "100px",
              overflow: "auto"
            }, children: node.content.length > 200 ? node.content.slice(0, 200) + "..." : node.content })
          ]
        },
        node.id
      )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "16px" }, children: [
        ...
        isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
            ...
            maxHeight: "200px",
            overflow: "auto"
          }, children: selectedNode.content || "(内容なし)" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "16px" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "8px", flexWrap: "wrap" }, children: [
          isConnectingParent ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            selectedNode.type !== "root" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleStartConnectParent, style: actionButtonStyle, children: "🔗 親ノード追加" })
          ] }),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { style: { margin: 0, fontSize: "20px", display: "flex", alignItems: "center", gap: "8px" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "📋" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "ボード情報" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "16px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "12px", color: "#94a3b8", marginBottom: "6px" }, children: "タイトル" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "18px", fontWeight: "bold" }, children: board.title })
            ] }),
            board.description && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "16px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "12px", color: "#94a3b8", marginBottom: "6px" }, children: "説明" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
                fontSize: "14px",
                color: "#e2e8f0",
                padding: "12px",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "16px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "12px", color: "#94a3b8", marginBottom: "6px" }, children: "デフォルト設定" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
                fontSize: "13px",
                padding: "12px",
                background: "#0f172a",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "4px" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#94a3b8" }, children: "プロバイダ:" }),
                  " ",
                  board.settings.defaultProvider
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "4px" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#94a3b8" }, children: "モデル:" }),
                  " ",
                  board.settings.defaultModel
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#94a3b8" }, children: "温度:" }),
                  " ",
                  board.settings.temperature
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "12px", color: "#64748b" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                "作成: ",
...
const App = () => {
  ...
  const { board } = useBoardStore();
  const [showBoardInfo, setShowBoardInfo] = reactExports.useState(false);
  reactExports.useEffect(() => {
    loadSettings();
  }, [loadSettings]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, position: "relative" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MindMapCanvas, {}),
